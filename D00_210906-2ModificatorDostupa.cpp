...
СОДЕРЖАНИЕ ПРИВАТНОГО ПОЛЯ извне КЛАССА недоступно
только через публичного посредника (типа геттер и сеттер)
...
к ним НЕЛЬЗЯ обратиться через оператор .(точка) (Например object.x)

СОДЕРЖАНИЕ ПОЛЯ PROTECTED извне КЛАССА недоступно
только через публичного посредника (типа геттер и сеттер)
