...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   D04Ex03_210930Interface.cpp                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: areggie <areggie@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/29 22:54:48 by areggie           #+#    #+#             */
/*   Updated: 2021/12/11 19:54:52 by areggie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Этот класс имеет ЧИСТО ВИРТУАЛЬНЫЕ методы (=0) в подклассах-наследниках. У ИНТЕРФЕЙСА
отсутствует файл с реализацией (имплементацией)
