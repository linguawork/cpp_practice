...
УДОБСТВО заключается в том, что в отличие от указателя не нужно писать амперсанд с аргументом в вызываемой функции в MAIN
...
int main()
{
	...
	//  так как работаем со ссылкой то НЕ ПИШЕМ амперсанд
	Foo(value_a, value_b, value_c); 
