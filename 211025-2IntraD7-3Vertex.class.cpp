...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   211025-2Vertex.class.cpp                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: areggie <areggie@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/25 14:40:09 by areggie           #+#    #+#             */
/*   Updated: 2021/10/25 17:07:32 by areggie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Здесь пример применения дфеолтного ттипа данных в шаблоне в пустых треугольных скобках <> (если не объявлен другой тип)
...
// и мы не знаем с каким типом данных мы будет работать через шаблон
{
...
int main(void)
{
	...
	// объявление дефолтного шаблона (который заявлен как float),  в шевронах ничего не написано
	// они пустые <>

	std::cout << v1 << std::endl; // применение оператора перегрузки
